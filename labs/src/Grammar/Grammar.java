...
public class Grammar {
    ...
    public String toString() {
        ...
        for (String nonTerminal : nonTerminals) {
            ...
            List<String> productionRuleStrings = new ArrayList<>();
            for (ProductionRule productionRule : productionRules) {
                if (productionRule.getLeftHandSide().equals(nonTerminal)) {
                    productionRuleStrings.add(String.join("", productionRule.getRightHandSide()));
                }
            }

            sb.append(String.join(" | ", productionRuleStrings)).append("\n");
        }
